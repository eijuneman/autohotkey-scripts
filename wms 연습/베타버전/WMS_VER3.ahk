...
Gui, Add, GroupBox, x80 y9 w472 h695 , 제품 재고 정보
...
Gui, %상태%:Add, ListView, x10 y+4 w1120 h463 grid vLVedsm1 gLVedsm1 hwndHLVedsm1 -ReadOnly WantF2 -Multi NoSortHdr, 태|로케이션|품명|규격|단위|현재재고
...
SoundPlay, %A_WorkingDir%\sound\SFX_Ui07.mp3
	...
	LV_GetText(OutputVar, selectRowNum, 2)
