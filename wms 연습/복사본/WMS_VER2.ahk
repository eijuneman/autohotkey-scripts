...
run, ttermpro.exe, C:\Program Files (x86)\teraterm
		...
		WinWait, ahk_exe ttermpro.exe,
		IfWinNotActive, ahk_exe ttermpro.exe, , WinActivate, ahk_exe ttermpro.exe,
		WinWaitActive, ahk_exe ttermpro.exe,
...
Gui, Add, Picture, x10 y10 w0 h0 vcolor3, %A_ScriptDir%\blue.png
Gui, Add, Picture, x10 y10 w0 h0 vcolor4, %A_ScriptDir%\blue.png
Gui, Add, Picture, x10 y10 w0 h0 vcolor5, %A_ScriptDir%\blue.png
Gui, Add, Picture, x10 y10 w0 h0 vcolor6, %A_ScriptDir%\blue.png
Gui, Add, Picture, x10 y10 w0 h0 vcolor7, %A_ScriptDir%\blue.png
Gui, Add, Picture, x10 y10 w0 h0 vcolor8, %A_ScriptDir%\blue.png
Gui, Add, Picture, x10 y10 w0 h0 vcolor9, %A_ScriptDir%\blue.png
...
Gui, Add, Edit, x147 y104 w140 h20 -vscroll v상품코드,
...
Gui, Add, Text, x27 y179 w260 h20 , 라인    칸          줄          칸
...
Gui, Add, UpDown,,1
Gui, Font, S8 CDefault, Malgun Gothic
Gui, Add, Button, x267 y198 w25 h30 gselect1, ★
...
Gui, Add, Button, x267 y289 w25 h30 gselect2, ★
Gui, Add, Button, x267 y319 w25 h30 gselect3, ★
Gui, Add, Button, x267 y349 w25 h30 gselect4, ★
Gui, Add, Button, x267 y379 w25 h30 gselect5, ★
Gui, Add, Button, x267 y409 w25 h30 gselect6, ★
Gui, Add, Button, x267 y439 w25 h30 gselect7, ★
Gui, Add, Button, x267 y469 w25 h30 gselect8, ★
Gui, Add, Button, x267 y499 w25 h30 gselect9, ★
...
Gui, Add, Edit, x317 y449 w200 h80 v비고,
...
Gui, Add, Button, x647 y474 w29 h30 gC8_1, C8_1
Gui, Add, Button, x678 y474 w29 h30 gC7_1, C7_1
...
Gui, Add, Button, x1227 y284 w19 h50 gK1_1, K1_1
Gui, Add, Button, x1227 y229 w19 h50 gK1_2, K1_2
Gui, Add, Button, x1206 y284 w19 h50 gK2_1, K2_1
Gui, Add, Button, x1206 y229 w19 h50 gK2_2, K2_2
Gui, Add, Button, x1178 y284 w19 h50 gK3_1, K3_1
Gui, Add, Button, x1178 y229 w19 h50 gK3_2, K3_2
Gui, Add, Button, x1157 y284 w19 h50 gK4_1, K4_1
Gui, Add, Button, x1157 y229 w19 h50 gK4_2, K4_2
Gui, Add, Button, x1122 y284 w24 h50 gK5_1, K5_1
Gui, Add, Button, x1122 y229 w24 h50 gK5_2, K5_2
Gui, Add, Button, x1096 y284 w24 h50 gK6_1, K6_1
Gui, Add, Button, x1096 y229 w24 h50 gK6_2, K6_2
Gui, Add, Button, x1062 y284 w24 h50 gK7_1, K7_1
Gui, Add, Button, x1062 y229 w24 h50 gK7_2, K7_2
Gui, Add, Button, x1036 y284 w24 h50 gK8_1, K8_1
Gui, Add, Button, x1036 y229 w24 h50 gK8_2, K8_2
...
Gui, Add, Button, x317 y389 w70 h25  gbcaledit, 전산수정
...
Gui, Show, x0 y0 w1366 h730, %WINTITLE%
...
GuiControl,, PG, +10
    ...
    Sleep,200
    ControlSetText, TRzEdit2, %상품코드%, ahk_class TfmMain
...
GuiControl, Move, colorbutton, x315 y387 w69 h29
GuiControl, enable, bcaledit
...
GuiControl,, PG, 30
ControlClick, Button1, %WINTITILE%
ControlClick, Button1, %WINTITILE%
GuiControl,, PG, 60
  ControlClick, Button1, %WINTITILE%
      SoundPlay, %A_ScriptDir%\sound\sound22.wav
...
Sleep,10
    ...
    controlsend, combobox1, {BackSpace 10}, %WINTITILE%
Sleep,10
    controlsend, combobox1, {ctrl down}v{ctrl up}, %WINTITILE%
Sleep,10
...
ControlFocus, ComboBox1, %WINTITILE%
...
GuiControl,, PG, +10
GuiControl,, PG, 0
    SB_SetText(frmSAVEDPRESET " 카드 조회 완료")
Sleep,500
}
...
정보추출:
{
          SoundPlay, %A_ScriptDir%\sound\sound44.wav
          Sleep, 800
          SoundPlay, %A_ScriptDir%\sound\sound1_1.mp3
GuiControl,, PG, +10
...
GuiControl,, PG, +10
    ...
    ControlGetText, p, edit4, %WINTITILE%
    Sleep,200
...
ControlClick, TAdvToolBar2, ahk_exe JedaeroM.exe, , , , x33 y33
    Sleep,2000
...
ControlClick, TAdvToolBar3, ahk_class TfmMain, , , , x160 y17
GuiControl,, PG, +10
Sleep, 500
...
GuiControl,, PG, +10
    ControlSetText, Edit6, %a%, %WINTITILE%
    ControlSetText, Edit7, %b%, %WINTITILE%
    ControlSetText, Edit8, %c%, %WINTITILE%
    ControlSetText, Edit9, %d%, %WINTITILE%
    ControlSetText, Edit10, %e%, %WINTITILE%
    ControlSetText, Edit11, %f%, %WINTITILE%
...
Sleep, 100
    ...
    controlclick, TAdvToolBar3, ahk_class TfmMain, , , , x270 y17
...
수량수정:
{
              SoundPlay, %A_ScriptDir%\sound\sound33.wav
          Sleep, 800
    SoundPlay, %A_ScriptDir%\sound\sound2_1.mp3

GuiControl,, PG, +10

    ControlGetText, a, Edit6, %WINTITILE%
    ControlGetText, b, Edit7, %WINTITILE%
    ControlGetText, c, Edit8, %WINTITILE%
    ControlGetText, d, Edit9, %WINTITILE%
    ControlGetText, e, Edit10, %WINTITILE%
    ControlGetText, f, Edit11, %WINTITILE%
    ControlGetText, h, Edit13, %WINTITILE%

GuiControl,, PG, +10
    g := h + b - c - d + e
    ControlSetText, edit12, %g%, %WINTITILE%
    ControlGetText, g, Edit12, %WINTITILE%
    ControlGetText, p, edit4, %WINTITILE%
    GuiControl,, PG, +10
    Winwait, ahk_exe JedaeroM.exe
    IfWinNotActive, ahk_exe JedaeroM.exe,
...
GuiControl,, PG, +10
    ...
    ControlSend, TRzDateTimeEdit1, %어제날짜%, ahk_class TfmMain
    Sleep,200
    ControlSetText, TRzEdit2, %p%, ahk_class TfmMain
    ControlClick, TRzPanel4, ahk_class TfmMain, , , , x257 y10
    Sleep, 1000
GuiControl,, PG, +10
    send, %g%{enter}
...
품목등록:
{
              SoundPlay, %A_ScriptDir%\sound\sound33.wav
          Sleep, 800
    SoundPlay, %A_ScriptDir%\sound\sound4_1.mp3
GuiControl,, PG, +10
	WinMenuSelectItem, ahk_exe ttermpro.exe, , 수정(E), 화면 선택(E)
	WinMenuSelectItem, ahk_exe ttermpro.exe, , 수정(E), 복사(C)
GuiControl,, PG, +10
...
GuiControl,, PG, +10
    ...
    ControlGetText, n1, TRzDBEdit18, ahk_exe JedaeroM.exe ;품명
    ControlGetText, n2, TRzDBEdit17, ahk_exe JedaeroM.exe ; 규격


    ControlGetText, c1, TRzDBEdit16, ahk_exe JedaeroM.exe ; 관리코드
GuiControl,, PG, +10
Sleep,100
    ControlSetText,	Edit2, %n1%, %WINTITILE%,
GuiControl,, PG, +10
    ControlSetText,	Edit3, %n2%, %WINTITILE%,
    ControlSetText,	Edit4, %c1%, 신흥목 재재고파악수정 1.0,
    Sleep,500
    ControlClick, Button1, ahk_exe AutoHotkey.exe
GuiControl,, PG, +10
    Sleep, 500
...
GuiControl,, PG, +10
    SB_SetText(frmSAVEDPRESET " 제품등록 완료")
...
GuiControl,, PG, +10
    ;~ ControlSetText, Edit5, , ahk_exe AutoHotkey.exe
        ControlSetText, Edit5, %어제날짜%, %WINTITILE%
    ControlSetText, Edit6, , ahk_exe AutoHotkey.exe
...
;~ winkill, ahk_exe JedaeroM.exe
          ...
          ;~ SoundPlay, %A_ScriptDir%\sound\sound33.wav
          ;~ Sleep, 800
        ;~ SoundPlay, %A_ScriptDir%\sound\sound6_1.mp3
        ;~ Sleep, 500
;~ winkill, auto
...
장부열기:
          SoundPlay, %A_ScriptDir%\sound\sound11.wav
WinMinimize, auto
Sleep, 200
winminimize, %WINTITILE%
Sleep, 200
WinMinimize, ahk_exe ttermpro.exe
WinMaximize,  ahk_exe JedaeroM.exe
Sleep, 200
winmove, ahk_exe JedaeroM.exe, , 0, 0, 1366, 820
Sleep, 200
ControlClick, TAdvToolBar1, ahk_exe JedaeroM.exe,,,,x61 y21
Sleep,500
control, hide, , TRzPanel7, ahk_exe JedaeroM.exe

control, choose, 2, TRzComboBox4, ahk_exe JedaeroM.exe
ControlClick, TRzButton2, ahk_exe JedaeroM.exe
ControlClick, TAdvToolBar2, ahk_exe JedaeroM.exe,,,,x47 y14
control, hide, , TRzPanel7, ahk_exe JedaeroM.exe
control, hide, , TAdvToolBar4, ahk_exe JedaeroM.exe
control, Disable, , TRzComboBox4, ahk_exe JedaeroM.exe
control, Disable, , TRzComboBox3, ahk_exe JedaeroM.exe
control, Disable, , TRzEdit1, ahk_exe JedaeroM.exe
ControlClick, TfmChitInfo1,ahk_exe JedaeroM.exe,,,,x938 y13
...
Sleep, 1000
GuiControl,, PG2, +10
ControlClick, TAdvToolBar3, ahk_exe JedaeroM.exe, , , , x51 y15
...
;~ ControlGetText, lo1, combobox2,  %WINTITILE%
;~ ControlGetText, lo2, combobox3,  %WINTITILE%
;~ ControlGetText, lo3, combobox4,  %WINTITILE%
;~ ControlGetText, lo4, combobox5,  %WINTITILE%



location = %r1%%r2%-%r3%-%r4%
;~ MsgBox, %location%
ControlSetText, edit18, %location%, %WINTITILE%
ControlSetText, TRzDBEdit14 , %location%, ahk_exe JedaeroM.exe

Sleep, 200

GuiControl,, PG2, +10
ControlClick, TAdvToolBar3, ahk_exe JedaeroM.exe, , , , x123 y15
GuiControl,, PG2, +10
Sleep, 1000
...
timer:
{
;~ run, explorer, \\192.168.0.1\일정표 최근\WMS\
...
Sleep, 1000
    FileDelete, C:\Users\이부근\Desktop\WMS\*.xlsx
    if ErrorLevel = 1
    {
        filemove,  C:\Users\이부근\Desktop\WMS\어제자상품재고정보.xlsx, C:\Users\이부근\Desktop\어제자상품재고정보.xlsx, 1
        filemove,  C:\Users\이부근\Desktop\WMS\어제판매리스트.xlsx, C:\Users\이부근\Desktop\어제판매리스트.xlsx, 1
        filemove,  C:\Users\이부근\Desktop\WMS\오늘미래판매리스트.xlsx, C:\Users\이부근\Desktop\오늘미래판매리스트.xlsx, 1
    }
    else
    {
    }
...
FileCopy, \\192.168.0.1\일정표 최근\WMS\어제자상품재고정보.xlsx, C:\Users\이부근\Desktop\WMS\어제자상품재고정보.xlsx, 1
GuiControl,, PG, +10
Sleep,200
FileCopy, \\192.168.0.1\일정표 최근\WMS\어제판매리스트.xlsx, C:\Users\이부근\Desktop\WMS\어제판매리스트.xlsx, 1
GuiControl,, PG, +10
Sleep,200
FileCopy, \\192.168.0.1\일정표 최근\WMS\오늘미래판매리스트.xlsx, C:\Users\이부근\Desktop\WMS\오늘미래판매리스트.xlsx, 1
GuiControl,, PG, +10
