...
path1 = % A_ScriptDir "\어제판매리스트.xlsx"
...
path2 = % A_ScriptDir "\오늘미래판매리스트.xlsx"
...
X1.Sheets("sheet1").Range("A2:F2000").Sort(X1.Sheets("sheet1").Range("A1"))
...
X1.sheets("sheet1").Range("A1:F1").select
X1.Selection.merge
...
X1.sheets("sheet1").Range("B2").select
X1.Selection.delete
...
X1.Sheets("sheet1").Range("A2:F2").interior.colorindex := 6
...
X1.Sheets("sheet1").Pagesetup.FittopagesWide := 0
X1.Sheets("sheet1").Pagesetup.FittopagesTall := 1
...
SoundPlay, \\192.168.0.1\hdd2\일정표 최근\일정표220730\기록중.mp3
FormatTime, 오늘늘짜, , yyyyMMdd

PATH3 := % "\\192.168.0.1\hdd2\일정표 최근\일정표220730\일일재고체크" 오늘늘짜 ".CSV"

X1.ActiveWorkbook.Save
X1.ActiveWorkbook.SaveAs("\\192.168.0.1\hdd2\일정표 최근\일정표220730\" . 오늘늘짜, 62)
Sleep, 1000
