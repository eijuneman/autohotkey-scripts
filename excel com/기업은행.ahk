...
MsgBox, , 잠깐, 날짜 바꾸려면 바꾸세요`n5초 드립니다, 10
;~ Sleep, 2000
...
WinMove, 기업은행.xlsx - Excel, , -866, 619, 400, 400
...
imagefind(이미지이름){
	...
	Loop, 1000
	{
		...
		ImageSearch, x0, y0, 0, 0, 3859, 2039, *50 %경로%
		if (errorlevel = 1){
			sleep 10
			;~ 구분=1
		}
