...
SetWorkingDir, \\192.168.0.1\일정표 최근\일정표220730 ; Ensures a consistent starting directory.
SetControlDelay, 1
SetWinDelay, 1
SetKeyDelay, 1
SetMouseDelay, 1

SetWorkingDir, \\192.168.0.1\일정표 최근\일정표220730
...
;~ Gui, Color, FcFcFc                                  |             |             |               |             |             |             |             |             |
Gui, 1:Add, Tab3, x0 y0 w1281 h731 Background0xFF00FF grefreshtab1 vrefreshtab, 출고지시서`   |매입/발주`    |상품정보`     ` |사무 루틴`    |현장 루틴`    |수동 루틴`    |일일재고파악|
Gui, 1:Tab, 출고지시서`   ,,
...
Gui, 1:Add, DateTime, x20 y+0 w180 h30 vmonth1 Choose%todaynow% gmonth_1,  ;;;;;;;;;;;;;;;;;;;;;;;;

Gui, 1:Add, DateTime, x+10 w180 h30 vmonth2 Choose%A_month1% gmonth_2,
...
Gui, 1:Add, Picture, x+0 y60 w223 h50, %A_WorkingDir%\bum1.png
;~ Gui, 1:Add, Picture, x+10 w57 h50, %A_WorkingDir%\bum2.png
;~ Gui, 1:Add, Picture, x+10 w57 h50, %A_WorkingDir%\bum3.png


Gui, 1:Add, Button, x+10 y60 w50 h50 grefresh, 새로`n고침
;~ Gui, 1:Add, Button, x+10 w50 h50 g출하삭제작업, 과거`n기록
Gui, 1:Add, Button, x+30 w51 h50 greload, 재시작
Gui, 1:Add, Button, x+10 w51 h50 gchange, WMS



Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x20 y+10 w180 h25 , Ⅰ. 출고 리스트 업
Gui, 1:Font, S12 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, x20 y+0 w610 h230 vlv1 glv1 Grid hwndHLV1 Sort NoSortHdr -Multi BackgroundFFFCF3, 안보임|출하일|日|출고시각|업체명|출고지|人|門|`%
Gui, 1:ListView, lv1
LV_ModifyCol(1, 0) ;
LV_ModifyCol(2, 65)  ;
LV_ModifyCol(3, 30)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x20 y+5 w180 h25 , Ⅱ. 준비 중
Gui, 1:Font, S13 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, y+0 w610 h300 vlv2 glv2 Grid hwndHLV2 NoSortHdr Sort -Multi BackgroundFAFBED, 안보임|출하일|日|출고시각|업체명|출고지|人|門|`%
Gui, 1:ListView, lv2
LV_ModifyCol(1, 0) ;
LV_ModifyCol(2, 65)  ;
LV_ModifyCol(3, 30)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x650 y120 w180 h25 , Ⅲ. 준비 완료
Gui, 1:Font, S13 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, y+0 w610 h300 vlv3 glv3 Grid hwndHLV3 NoSortHdr Sort -Multi BackgroundF9FFF5, 안보임|출하일|日|출고시각|업체명|출고지|人|門|`%
Gui, 1:ListView, lv3
LV_ModifyCol(1, 0) ;
LV_ModifyCol(2, 65)  ;
LV_ModifyCol(3, 30)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x650 y+5 w180 h25, Ⅳ. 출하
Gui, 1:Font, S12 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, y+0 w610 h230 vlv11 glv11 Grid hwndHLV11 NoSortHdr Sort -Multi SortDesc BackgroundFFF0FA, 안보임|출하일|日|출고시각|업체명|출고지|人|門|`%
Gui, 1:ListView, lv11
LV_ModifyCol(1, 0) ;
LV_ModifyCol(2, 65)  ;
LV_ModifyCol(3, 30)  ;
...
/*
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, y+5 w200 h25 , Ⅴ. 채희창 과장 배송
Gui, 1:Font, S13 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, y+0 w610 h155 vlv22 Grid glv22 hwndHLV22 NoSortHdr -Multi SortDesc BackgroundFFB278, 안보임|출하일|日|출고시각|업체명|출고지|진행률|門
Gui, 1:ListView, LV22
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 75)  ;
LV_ModifyCol(3, 30)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, y+5 w200 h25 , Ⅵ. 여성구 기사 배송
Gui, 1:Font, S13 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, y+0 w610 h155 vlv33 Grid glv33 hwndHLV33 NoSortHdr -Multi SortDesc Background6CFFEA, 안보임|출하일|日|출고시각|업체명|출고지|진행률|門
Gui, 1:ListView, LV33
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 75)  ;
LV_ModifyCol(3, 30)  ;
...
;~ Gui, 1:Add, Button, x1000 y5 w100 h100 gGuiClose, 닫기

Gui, 1:Tab, 매입/발주`    ,,
Gui, 1:Add, GroupBox, x10 y30 w1260 h690, ; [ 매입 발주 루틴   ]



Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x20 y45 h25 w200, Ⅰ. 입하 리스트 업
;~ Gui, 1:Font, S13 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, Text, x+10 w55 h22 , 시작일
;~ Gui, 1:Font, S15 CDefault W400, Malgun Gothic
...
;~ Gui, 1:Add, Button, x+10 w65 h30 grefresh9, 새로고침
;~ Gui, 1:Add, Button, x+75 w35 h30 g9edit_1, 수정
;~ Gui, 1:Add, Button, x+10 w35 h30 g9add_1, 추가
;~ Gui, 1:Add, Button, x+10 w35 h30, 삭제
Gui, 1:Add, ListView, x20 y+5 w820 h170 vlv91 glv91 Grid hwndHLV91 NoSortHdr -Multi BackgroundFFFCF3, 안보임|발주일|日|입고일|日|입고시각|업체명|출고지|비고|담당자|진행률
Gui, 1:ListView, LV91
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, y+20 h25 w200, Ⅱ. 입하 / 입고 진행중
;~ Gui, 1:Font, S11 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, Text, x+10 w55 h22 , 시작일
;~ Gui, 1:Font, S15 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, DateTime, x+0 w140 h30 ;vmonth1_4 Choose%todaynow% gmonth_41,
...
Gui, 1:Font, S10 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, Button, x+10 w65 h30 grefresh9, 새로고침
;~ Gui, 1:Add, Button, x+10 w35 h30 g9edit_2, 수정
;~ Gui, 1:Add, Button, x+10 w35 h30 g9add_2, 추가
;~ Gui, 1:Add, Button, x+10 w35 h30, 삭제
Gui, 1:Add, ListView, x20 y+5 w820 h170 vLV92 glv92 Grid SortDesc hwndHLV92 NoSortHdr -Multi BackgroundFAFBED, 안보임|발주일|日|입고일|日|입고시각|업체명|출고지|비고|담당자|진행률
Gui, 1:ListView, LV92
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, y+20 h25 w200, Ⅲ. 입고 완료
;~ Gui, 1:Font, S11 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, Text, x+10 w55 h22 , 시작일
;~ Gui, 1:Font, S15 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, DateTime, x+0 w140 h30 ;vmonth1_4 Choose%todaynow% gmonth_41,
...
;~ Gui, 1:Add, Button, x+10 w35 h30 g9add_2, 추가
;~ Gui, 1:Add, Button, x+10 w35 h30, 삭제
Gui, 1:Add, ListView, x20 y+5 w820 h180 vLV93 glv93 Grid SortDesc hwndHLV93 NoSortHdr -Multi BackgroundEAF5F8, 안보임|발주일|日|입고일|日|입고시각|업체명|출고지|비고|담당자|진행률
Gui, 1:ListView, LV93
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
;~ Gui, 1:Font, S11 CDefault W700, Malgun Gothic
;~ Gui, 1:Add, Text, x435 y45 w175 h25 , Ⅲ. 3.3톤 지게차
;~ Gui, 1:Font, S11 CDefault w400, Malgun Gothic
;~ Gui, 1:Add, ListView, x435 y+5 w405 h290 vLV93 Grid NoSortHdr -Multi BackgroundFFF0FF, 안보임|시작일|日|목표일|日|번호|내용|진행률
;~ Gui, 1:ListView, LV53
;~ LV_ModifyCol(1, 0)
;~ LV_ModifyCol(2, 60)  ;
;~ LV_ModifyCol(3, 25)  ;
...
;~ LV_ModifyCol(6, 0)  ;
;~ LV_ModifyCol(7, 150)  ;
;~ LV_ModifyCol(8, "60 Integer" "Integer Right")

;~ Gui, 1:Font, S11 CDefault W700, Malgun Gothic
;~ Gui, 1:Add, Text, x435 y+20 w175 h25 , Ⅳ. 84무 8497
;~ Gui, 1:Font, S11 CDefault w400, Malgun Gothic
;~ Gui, 1:Add, ListView, x435 y+5 w405 h290 vLV94 Grid NoSortHdr -Multi BackgroundFFF0FF, 안보임|시작일|日|목표일|日|번호|내용|진행률
;~ Gui, 1:ListView, LV54
;~ LV_ModifyCol(1, 0)
;~ LV_ModifyCol(2, 60)  ;
;~ LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S11 CDefault W700 Cblue, Malgun Gothic
...
Gui, 1:Font, S11 CDefault W700, Malgun Gothic
Gui, 1:Add, MonthCal, x855 y+10 v9monthcal ;g9monthcal, ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
Gui, 1:Font, S10 CDefault W400, Malgun Gothic

Gui, 1:Add, Button, x1088 y80 w50 h50 grefresh9, 새로`n고침
Gui, 1:Add, Button, x+10 w51 h50 greload, 재시작
Gui, 1:Add, Button, x+10 w51 h50 gGuiClose, 닫기

Gui, 1:Add, Button, x1088 y+13 w50 h50 , 1`n추가
Gui, 1:Add, Button, x+10 w51 h50 , 2`n추가
Gui, 1:Add, Button, x+10 w51 h50 , 3`n추가

Gui, 1:Add, button, x1088 y+13 w35 h35 , 오늘
Gui, 1:Add, button, x+10 w35 h35 , 내일
Gui, 1:Add, button, x+10 w35 h35 , 요번주
Gui, 1:Add, button, x+10 w35 h35 , 이번달
...
;~ Gui, 1:Add, Text, x+10 w55 h22 , 종료일
;~ Gui, 1:Font, S11 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, DateTime, x+0 w145 h30 vmonth5_4 Choose%A_month1% gmonth_56,

;~ Gui, 1:Font, S11 CDefault w400, Malgun Gothic
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
gui, 1:Add, text, x855 y+20 h25 , Ⅴ. 일일 체크 리스트
Gui, 1:Font, S11 CDefault w400, Malgun Gothic
Gui, 1:Add, ListView, x855 y+5 w405 h420 vLV95 Grid NoSortHdr -Multi BackgroundFFF0FA, 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV55
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
;~ Gui, 1:Font, S11 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, DateTime, x+0 w140 h30 Choose%todaynow% gmonth_41,
;~ Gui, 1:Font, S13 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, Text, x+10 w55 h22 , 종료일
;~ Gui, 1:Font, S11 CDefault W400, Malgun Gothic
;~ Gui, 1:Add, DateTime, x+0 w140 h30 Choose%A_month1% gmonth_42,
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
...
Gui, 1:Add, Listbox, y+0 w200 h570 v소분류3 g소분류3 hwndH소분류3 BackgroundFFA0FA,
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x230 y45 w180 h25 , Ⅲ. 제품정보

Gui, 1:Font, S11 CDefault W300, Malgun Gothic

Gui, 1:Add, ListView,  y+10 w1020 h630 vLV31 Grid hwndHLV31 gLV31 -Multi BackgroundFFF0FA, 상품명|규격|바코드|관리코드|적정재고|현재고|단위|A단가|매출단가|B단가|소매단가|C단가|중분류|소분류
...
Gui, 1:Font, S11 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, x20 y+5 w400 h595 vLV41 Grid gLV41 -Multi BackgroundFFF0FA, 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV41
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S11 CDefault w400, Malgun Gothic
Gui, 1:Add, ListView, x435 y+5 w405 h595 vLV42 gLV42 Grid NoSortHdr -Multi BackgroundFFF0FF, 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV42
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S13 CDefault W700 Cblue, Malgun Gothic
gui, 1:Add, text, x855 y45 h25 ,[오늘]
Gui, 1:Font, S13 CDefault W700 Cblue, Malgun Gothic
gui, 1:Add, text, x+5 w170 h25,%todaynow1%
;~ Gui, 1:Font, S11 CDefault W400, Malgun Gothic
...
Gui, 1:Add, ListView, x855 y+5 w405 h400 vLV43 gLV43 Grid NoSortHdr -Multi BackgroundEAF5F8, 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV43
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x20 y45 w180 h25 , Ⅰ. CNC
Gui, 1:Font, S11 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, y+5 w400 h290 vLV51 Grid -Multi BackgroundFFFAFF, 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV51
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, y+20 w180 h25 , Ⅲ. 83너 5932
Gui, 1:Font, S11 CDefault W300, Malgun Gothic
Gui, 1:Add, ListView, x20 y+5 w400 h290 vLV52 Grid -Multi BackgroundF9FFF5, 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV52
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x435 y45 w175 h25 , Ⅱ. 3.3톤 지게차
Gui, 1:Font, S11 CDefault w400, Malgun Gothic
Gui, 1:Add, ListView, x435 y+5 w405 h290 vLV53 Grid NoSortHdr -Multi BackgroundFFFCF3, 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV53
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Add, Text, x435 y+20 w175 h25 , Ⅳ. 84무 8497
Gui, 1:Font, S11 CDefault w400, Malgun Gothic
Gui, 1:Add, ListView, x435 y+5 w405 h290 vLV54 Grid NoSortHdr -Multi BackgroundFAFBED , 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV54
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Add, Button, x1088 y74 w50 h50 , 새로`n고침
Gui, 1:Add, Button, x+10 w51 h50 greload, 재시작
Gui, 1:Add, Button, x+10 w51 h50 gGuiClose, 닫기

Gui, 1:Add, Button, x1088 y+13 w50 h50 , CNC`n추가
Gui, 1:Add, Button, x+10 w51 h50 , 지게차`n추가
Gui, 1:Add, Button, x+10 w51 h50 , 일일`n추가
...
gui, 1:Add, text, x855 y+20 h25 , Ⅴ. 일일 체크 리스트
Gui, 1:Font, S11 CDefault w400, Malgun Gothic
Gui, 1:Add, ListView, x855 y+5 w405 h420 vLV55 Grid NoSortHdr -Multi BackgroundEAF5F8, 안보임|시작일|日|목표일|日|번호|내용|진행률
Gui, 1:ListView, LV55
LV_ModifyCol(1, 0)
LV_ModifyCol(2, 60)  ;
LV_ModifyCol(3, 25)  ;
...
Gui, 1:Font, S13 CDefault W700, Malgun Gothic
Gui, 1:Add, Text, x20 y90 h25 w250, Ⅰ. 일일재고관리
...
Gui, 1:Add, ListView, x20 y+0 w250 h590 vlvedsm glvedsm Grid hwndHLVedsm NoSortHdr -Multi BackgroundFFFCF3, 안보임|년도|발주일|日|진행률
...
Gui, 1:Add, ListView, x+10 w970 h590 vlvco glvco Grid hwndHLVco NoSortHdr -Multi BackgroundFFFCF3, 중분류|소분류|상품명|규격|적정|현재|단위|기호|부족|밴딩
...
CLV22 := New LV_Colors(HLV22)
CLV33 := New LV_Colors(HLV33)
;~ CLV4 := New LV_Colors(HLV11)
;~ CLV5 := New LV_Colors(HLV22)
;~ CLV6 := New LV_Colors(HLV33)
WinSet, Redraw, , ahk_id %HLV1%
WinSet, Redraw, , ahk_id %HLV2%
WinSet, Redraw, , ahk_id %HLV3%
WinSet, Redraw, , ahk_id %HLV11%
WinSet, Redraw, , ahk_id %HLV22%
;~ WinSet, Redraw, , ahk_id %HLV33%
...
refresh:
				;~ MsgBox, %A_WorkingDir%\sound\새로고침.mp3
	...
	IfMsgBox Yes
	{
		...
		MsgBox, 262196, 일정 삭제, 정말 입니까?
		{
			IfMsgBox Yes
			{
				...
				root1 := % A_WorkingDir "\" TempFile
				root2 := % A_WorkingDir "\삭제일정\" TempFile1
...
;~ GuiControl, -Redraw, %HLV22%
;~ GuiControl, -Redraw, %HLV33%
...
;~ Run explore \\192.168.0.1\일정표 최근\일정표220730, , hide, PID
Sleep, 100
...
NewStr := RegExReplace(1output1, "-" , Replacement := "")
	If ((month11 <= NewStr) && (NewStr <= month21))
	{
				...
				rootfile1 = % A_WorkingDir "\" A_LoopFileName
...
Loop % LV_GetCount()
{
	...
	;~ else
	;~ {
	;~ CLV1.ROW(A_Index, 0xFFFCF3, 0x000000)
	;~ }
	...
	;~ CLV1.Cell(A_Index, 8, 0xFFFCF3, 0x000000)
	}
	else
	{
	CLV1.Cell(A_Index, 8, 0xFFFCF3, 0x000000)
	...
	if (OutputVar7 = "여"){
	CLV1.Cell(A_Index, 7, 0x6CFFEA, 0x000000)
	}
	else if (OutputVar7 = "채"){
	CLV1.Cell(A_Index, 7, 0xFFB278, 0x000000)
	}
	else
	{
	;~ CLV1.Cell(A_Index, 7, 0xFFFCF3, 0x000000)
	}
...
Loop % LV_GetCount()
{
	...
	;~ NewStr := RegExReplace(newtext, "," , Replacement := "")
	;~ if (NewStr = "0"){
	;~ CLV2.ROW(A_Index, 0xFF31E2, 0x000000)
	;~ }
	;~ else
	;~ {
	;~ CLV2.ROW(A_Index, 0xFAFBED, 0x000000)
	;~ }
	...
	;~ Clv2.Cell(A_Index, 8, 0xFAFBED, 0x000000)
	}
	else
	{
	;~ Clv2.Cell(A_Index, 8, 0xFAFBED, 0x000000)
		    ...
		    LV_GetText(OutputVar7, A_Index, 7)
	if (OutputVar7 = "여"){
	CLV2.Cell(A_Index, 7, 0x6CFFEA, 0x000000)
	}
	else if (OutputVar7 = "채"){
	CLV2.Cell(A_Index, 7, 0xFFB278, 0x000000)
	}
	else
	{
	;~ CLV2.Cell(A_Index, 7, 0xFAFBED, 0x000000)
	}
...
Loop % LV_GetCount()
{
	...
	;~ else
	;~ {
	;~ CLV3.ROW(A_Index, 0xF9FFF5, 0x000000)
	;~ }
	...
	;~ Clv3.Cell(A_Index, 8, 0xF9FFF5, 0x000000)
	}
	else
	{
	;~ Clv3.Cell(A_Index, 8, 0xF9FFF5, 0x000000)
		    ...
		    LV_GetText(OutputVar7, A_Index, 7)
	if (OutputVar7 = "여"){
	CLV3.Cell(A_Index, 7, 0x6CFFEA, 0x000000)
	}
	else if (OutputVar7 = "채"){
	CLV3.Cell(A_Index, 7, 0xFFB278, 0x000000)
	}
	else
	{
	;~ CLV3.Cell(A_Index, 7, 0xF9FFF5, 0x000000)
	}
...
Loop % LV_GetCount()
{
	...
	{
	;~ CLV11.Cell(A_Index, 8, 0xFFF0FA, 0x000000)
	}
		    ...
		    LV_GetText(OutputVar7, A_Index, 7)
	if (OutputVar7 = "여"){
	CLV11.Cell(A_Index, 7, 0x6CFFEA, 0x000000)
	}
	else if (OutputVar7 = "채"){
	CLV11.Cell(A_Index, 7, 0xFFB278, 0x000000)
	}
	else
	{
	;~ CLV11.Cell(A_Index, 7, 0xFFF0FA, 0x000000)
	}
...
{
RegExMatch(A_LoopFileName, "A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V채_G(.*)_(.*).CSV", 22output)
...
RegExMatch(22output1, "2023-(.*)-(.*)", 22date)
NewStr := RegExReplace(22output1, "-" , Replacement := "")
	If ((month11 <= NewStr) && (NewStr <= month21))
	{
		LV_Add("", "A" 22output1 "_B" 22output2 "_C" 22output3 "_D" 22output4 "_E" 22output5 "_V채_G" 22output6 "_" 22output7 ".CSV", 22date1 "-" 22date2, Get_Weekday(NewStr, parmMode), 22output2, 22output3, 22output4, 퍼센트, 22output6)
	                             ; 안보임																							|출하일|				日|					출고시각|	업체명|		출고지|		완료
	}
...
;~ MsgBox, % RetrievedText
    if (RetrievedText = "예"){
      CLV22.cell(A_Index, 8, 0xFF31E2, 0xffffff)
	}
	else if (RetrievedText = "우"){
		CLV22.cell(A_Index, 8, 0x61C600, 0xFFFFFF)
	}
	else if (RetrievedText = "재"){
	CLV22.cell(A_Index, 8, 0x00B9F2, 0x000000)
	}
	else if (RetrievedText = "크"){
	CLV22.cell(A_Index, 8, 0xFF1733, 0xffffff)
	}
	else if (RetrievedText = ""){
	CLV22.cell(A_Index, 8, 0xFFB278, 0x000000)
	}
	else
	{
	CLV22.cell(A_Index, 8, 0xFFB278, 0x000000)
...
Loop, %A_WorkingDir%\*.CSV
{
RegExMatch(A_LoopFileName, "A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V여_G(.*)_(.*).CSV", 33output)
...
RegExMatch(33output1, "2023-(.*)-(.*)", 33date)
NewStr := RegExReplace(33output1, "-" , Replacement := "")
	If ((month11 <= NewStr) && (NewStr <= month21))
	{
		LV_Add("", "A" 33output1 "_B" 33output2 "_C" 33output3 "_D" 33output4 "_E" 33output5 "_V여_G" 33output6 "_" 33output7 ".CSV", 33date1 "-" 33date2, Get_Weekday(NewStr, parmMode), 33output2, 33output3, 33output4, 퍼센트, 33output6)
	}
	else
	{
	}
...
Loop % LV_GetCount()
{
    ...
    if (RetrievedText = "예"){
	CLV33.cell(A_Index, 8, 0xFF31E2, 0xffffff)
	}
	else if (RetrievedText = "우"){
	CLV33.cell(A_Index, 8, 0x61C600, 0xFFFFFF)
	}
	else if (RetrievedText = "재"){
	CLV33.cell(A_Index, 8, 0x00B9F2, 0x000000)
	}
	else if (RetrievedText = "크"){
	CLV33.cell(A_Index, 8, 0xFF1733, 0xffffff)
	}
	else if (RetrievedText = ""){
	CLV33.cell(A_Index, 8, 0x6CFFEA, 0x000000)
	}
	else
	{
	CLV33.cell(A_Index, 8, 0x6CFFEA, 0x000000)
...
;~ GuiControl, enable, LV22
;~ GuiControl, enable, LV33
...
;~ GuiControl, show, lv22
;~ GuiControl, show, lv33
...
{
RegExMatch(A_LoopFileName, "A(.*)_A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V(.*)_G(.*)_C", 91output)
RegExMatch(91output1, "2023-(.*)-(.*)", 91date1)
RegExMatch(91output2, "2023-(.*)-(.*)", 91date2)
NewStr1 := RegExReplace(91output1, "-" , Replacement := "")
NewStr2 := RegExReplace(91output2, "-" , Replacement := "")
	;~ If ((month11 <= NewStr) && (NewStr <= month21))
	;~ {


			rootfile1 = % A_WorkingDir "\매입\" A_LoopFileName

		PERCENT9(rootfile1)
		;~ MsgBox, % COUNT


		LV_Add("", "A" 91output1 "_A" 91output2 "_B" 91output3 "_C" 91output4 "_D" 91output5 "_E"  91output6 "_V" 91output7 "_G" 91output8 "_C.CSV", 91date11 "-" 91date12, Get_Weekday(NewStr1, parmMode), 91date21 "-" 91date22, Get_Weekday(NewStr2, parmMode), 91output3, 91output4, 91output5, 91output6, 91output7, COUNT "%")
	;~ }
	;~ else
	;~ {
	;~ }
...
Loop % LV_GetCount()
{
	...
	{
	CLV91.ROW(A_Index, 0xFFFCF3, 0x000000)
	}
...
{
RegExMatch(A_LoopFileName, "A(.*)_A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V(.*)_G(.*)_B", 92output)

RegExMatch(92output1, "2023-(.*)-(.*)", 92date1)
RegExMatch(92output2, "2023-(.*)-(.*)", 92date2)
NewStr1 := RegExReplace(92output1, "-" , Replacement := "")
NewStr2 := RegExReplace(92output2, "-" , Replacement := "")
	;~ If ((month11 <= NewStr) && (NewStr <= month21))
	;~ {
		...
		LV_Add("", "A" 92output1 "_A" 92output2 "_B" 92output3 "_C" 92output4 "_D" 92output5 "_E"  92output6 "_V" 92output7 "_G" 92output8 "_B.CSV", 92date11 "-" 92date12, Get_Weekday(NewStr1, parmMode), 92date21 "-" 92date22, Get_Weekday(NewStr2, parmMode), 92output3, 92output4, 92output5, 92output6, 92output7, COUNT "%")
	;~ }
	;~ else
	;~ {
	;~ }
...
Loop % LV_GetCount()
{
	...
	{
	CLV92.ROW(A_Index, 0xFAFBED, 0x000000)
	}
...
{
RegExMatch(A_LoopFileName, "A(.*)_A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V(.*)_G(.*)_A", 93output)

RegExMatch(93output1, "2023-(.*)-(.*)", 93date1)
RegExMatch(93output2, "2023-(.*)-(.*)", 93date2)
NewStr1 := RegExReplace(93output1, "-" , Replacement := "")
NewStr2 := RegExReplace(93output2, "-" , Replacement := "")
	;~ If ((month11 <= NewStr) && (NewStr <= month21))
	;~ {
		...
		LV_Add("", "A" 93output1 "_A" 93output2 "_B" 93output3 "_C" 93output4 "_D" 93output5 "_E"  93output6 "_V" 93output7 "_G" 93output8 "_A.CSV", 93date11 "-" 93date12, Get_Weekday(NewStr1, parmMode), 93date21 "-" 93date22, Get_Weekday(NewStr2, parmMode), 93output3, 93output4, 93output5, 93output6, 93output7, COUNT "%")
	;~ }
	;~ else
	;~ {
	;~ }
...
Loop % LV_GetCount()
{
	...
	{
	CLV93.ROW(A_Index, 0xEAF5F8, 0x000000)
	}
...
Clipboard = %A_WorkingDir%\부족재고관리\부족재고관리.CSV

contain := % Clipboard



FileRead, dataCO, %Clipboard%
	...
	else
	{
		...
		MsgBox , 262192, 문제발생, 읽기 실패`n관리자에게 문의하세요
...
GuiControl, , 4t1, %addtimetoday1%
GuiControl, , 4t2, %addtimetoday2%
...
;~ MsgBox,  %vMonthStart1% %vMonthEnd1% %vDate43% %vDate44% %4monthcal% %4monthcal%
...
{
RegExMatch(A_LoopFileName, "30_P(.*)_Q(.*)_R(.*)_S(.*)_T(.*)_U(.*).CSV", 41output)
...
NewStr1 := RegExReplace(41output1, "-" , Replacement := "")
NewStr2 := RegExReplace(41output2, "-" , Replacement := "")
	If ((month41_11 <= NewStr1) && (NewStr1 <= month41_21))
	{
		...
		LV_Add("", A_WorkingDir "\사무루틴\30_P" 41output1 "_Q" 41output2 "_R" 41output3 "_S" 41output4 "_T" 41output5 "_U" 41output6 ".CSV", 41date1_1 "-" 41date1_2, Get_Weekday(NewStr1, parmMode), 41date2_1 "-" 41date2_2, Get_Weekday(NewStr2, parmMode), 41output3, 41output4, COUNT "%")
...
Loop, %A_WorkingDir%\사무루틴\*.CSV
{
RegExMatch(A_LoopFileName, "7_P(.*)_Q(.*)_R(.*)_S(.*)_T(.*)_U(.*).CSV", 42output)
...
NewStr1 := RegExReplace(42output1, "-" , Replacement := "")
NewStr2 := RegExReplace(42output2, "-" , Replacement := "")
	If ((month42_11 <= NewStr1) && (NewStr1 <= month42_21))
	{
		...
		LV_Add("", A_WorkingDir "\사무루틴\7_P" 42output1 "_Q" 42output2 "_R" 42output3 "_S" 42output4 "_T" 42output5 "_U" 42output6 ".CSV", 42date1_1 "-" 42date1_2, Get_Weekday(NewStr1, parmMode), 42date2_1 "-" 42date2_2, Get_Weekday(NewStr2, parmMode), 42output3, 42output4, COUNT "%")
...
Loop, %A_WorkingDir%\사무루틴\*.CSV
{
RegExMatch(A_LoopFileName, "2_P(.*)_Q(.*)_R(.*)_S(.*)_T(.*)_U(.*).CSV", 43output)
...
NewStr1 := RegExReplace(43output1, "-" , Replacement := "")
NewStr2 := RegExReplace(43output2, "-" , Replacement := "")
	If ((month43_11 <= NewStr1) && (NewStr1 <= month43_21))
	{
		...
		LV_Add("", A_WorkingDir "\사무루틴\2_P" 43output1 "_Q" 43output2 "_R" 43output3 "_S" 43output4 "_T" 43output5 "_U" 43output6 ".CSV", 43date1_1 "-" 43date1_2, Get_Weekday(NewStr1, parmMode), 43date2_1 "-" 43date2_2, Get_Weekday(NewStr2, parmMode), 43output3, 43output4, COUNT "%")
...
RegExMatch(OutputVar, "A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V(.*)_G(.*)_(.*).CSV", ed)
RegExMatch(OutputVar, "G(.*)_(.*).CSV", 2ed)
;~ MsgBox, % ed8
상태 := 2ed2
	라벨 := "M"
파일이름 := OutputVar
...
RegExMatch(OutputVar, "A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V(.*)_G(.*)_", ed)
RegExMatch(OutputVar, "G(.*)_(.*).CSV", 2ed)
...
if A_GuiEvent = DoubleClick
{
	...
	RegExMatch(OutputVar, "30_P(.*)_Q(.*)_R(.*)_S(.*)_T(.*)_U(.*).CSV", 4ed)
	;~ MsgBox, % OutputVar
Clipboard := OutputVar
	상태 := "30"
	파일이름 = OutputVar
...
if A_GuiEvent = DoubleClick
{
	...
	Sleep, 100
;~ MsgBox,
	RegExMatch(OutputVar, "2_P(.*)_Q(.*)_R(.*)_S(.*)_T(.*)_U(.*).CSV", 4ed)
	;~ MsgBox, % OutputVar
...
if A_GuiEvent = DoubleClick
{
	...
	RegExMatch(OutputVar, "7_P(.*)_Q(.*)_R(.*)_S(.*)_T(.*)_U(.*).CSV", 4ed)
	;~ MsgBox, % OutputVar
Clipboard := OutputVar
	상태 := "7"
	파일이름 = OutputVar
...
if (contain = "\\192.168.0.1\일정표 최근\일정표220730\")
{
...
gui, %상태%:Add, progress, smooth x10 y135 w1120 h35 cFF66B2 vmyprogress, 0
...
Gui, %상태%:Add, ListView, x10 y+4 w1120 h463 grid vLV7 gLV7 hwndHLV7 -ReadOnly WantF2 NoSortHdr AltSubmit  Background%칼라%, 出|로케이션|내용|수량|단위|비고 및 주의사항|
...
Gui, %상태%:Add, combobox, x+10 w60 h40 -VScroll ve6 r3, |여|채
Gui, %상태%:Add, combobox, x+10 w60 h40 -VScroll ve7 r5, |예|우|재|크
...
SoundPlay, %A_WorkingDir%\sound\효과음91.mp3
...
GuiControl, , e4, %ed4%
GuiControl, , e5, %ed5%
GuiControl, ChooseString, e6, %ed6%
GuiControl, ChooseString, e7, %ed7%
GuiControl, , e0, %상태%
	...
	Loop % LV_GetCount()
	{
		...
		if (RetrievedText = "◎"){
		  ;~ LV_GetNext(StartingRowNumber, RowType)
			CLV7.ROW(A_Index, 0xFF007F, 0xffffff)
		}
		else if (RetrievedText = "★"){
		  ;~ LV_GetNext(StartingRowNumber, RowType)
...
Loop % LV_GetCount()
{
	...
	CLV7.ROW(A_Index, 0xFFF000, 0x000000)
      ...
      ;~ LV_GetNext(StartingRowNumber, RowType)
		CLV7.ROW(A_Index, 0x663399, 0xffffff)
	}
	else
	{
		CLV7.ROW(A_Index, 0x%칼라%, 0x000000)
...
변환결과 := "[Ⅰ. 출고 리스트 업]"
GuiControl, , e0, Y
;~ SoundPlay, \\192.168.0.1\일정표 최근\일정표220730\sound\골리앗1.mp3
gosub, 변환
return
...
IF(( 상태 = "B" ) or ( 상태 = "C" ) or ( 상태 = "A" ))
{
	deletefile := % "A" t1 "_A" t2 "_B" t3 "_C" t4 "_D" t5 "_E" t6 "_V" t7 "_G" t8 "_" 상태 ".CSV"
	   newfile := % "A" e1 "_A" e2 "_B" e3 "_C" e4 "_D" e5 "_E" e6 "_V" e7 "_G" e8 "_" 상태 ".CSV"
...
loop, % LV_GetCount() {
	...
	FileAppend, % col1 "," col2 "," col3 "," col4 "," col5 "," col6 "," col7 ", `n", % A_Desktop "\" newfile
	Sleep, 1
		GuiControl,, myprogress, +1
    }
	if erorrlevel = 0
	...
	IF(( 상태 = "B" ) or ( 상태 = "C" ) or ( 상태 = "A" ))
	{
		FileMove, % A_Desktop "\" newfile, % A_WorkingDir "\매입\" newfile, 1
	...
	{
		FileMove, % A_Desktop "\" newfile, % A_WorkingDir "\" newfile, 1
		GuiControl,, myprogress, 70
		Sleep, 200
		SoundPlay, %A_WorkingDir%\1.mp3
		root3 = % A_WorkingDir "\" newfile
		CSV_Load(root3, "rootcsv")
		CSV_Save(root3, "rootcsv", 1)
	}
...
GuiControl, , t5, %e5%
GuiControl, , t6, %e6%
GuiControl, text, t7, %e7%
GuiControl, text, t8, %e8%
GuiControl, , t0, %e0%
}
...
;~ MsgBox, % 라벨
	if (라벨 = "M"){
		Clipboard = %A_WorkingDir%\매입\%OutputVar%
		Clipboard1 = %A_WorkingDir%\매입\%OutputVar%
	}
	else if (라벨 = "N"){
		Clipboard = %A_WorkingDir%\매입\삭제일정\%OutputVar%
		Clipboard1 = %A_WorkingDir%\매입\삭제일정\%OutputVar%
	}
	else
	{
	}
...
if ((contain = "\\192.168.0.1\일정표 최근\일정표220730\매입\") or (contain = "\\192.168.0.1\일정표 최근\일정표220730\매입\") )
{
...
Gui, %상태%:Add, button, x+0 w50 h40 gbtt3, 품목
Gui, %상태%:Font, S17 Cred W400, Malgun Gothic
Gui, %상태%:Add, Edit, x+0 w80 h40 vtt4 gtt4,
Gui, %상태%:Add, Edit, x+0 w80 h40 vtt5,
Gui, %상태%:Add, Edit, x+0 w220 h40 vtt6,
Gui, %상태%:Font, S17 CDefault W400, Malgun Gothic
Gui, %상태%:Add, ListView, x10 y+4 w1120 h463 grid vLV7 gLV7 hwndHLV7 -ReadOnly WantF2 NoSortHdr AltSubmit  Background%칼라%, 出|로케이션|내용|수량|단위|비고 및 주의사항|
...
Gui, %상태%:Font, S19 CDefault W400, Malgun Gothic
Gui, %상태%:Add, Text, x10 y10 w150 h30 -VScroll, 발주날짜
Gui, %상태%:Add, Text, x+10 w150 h30 -VScroll, 입고날짜
Gui, %상태%:Add, Text, x+10 w100 h30 -VScroll, 입고시각
Gui, %상태%:Add, Text, x+10 w170 h30 -VScroll, 매입처
Gui, %상태%:Add, Text, x+10 w140 h30 -VScroll, 입하지
Gui, %상태%:Add, Text, x+10 w200 h30 -VScroll, 비고
Gui, %상태%:Add, Text, x+10 w60 h30 -VScroll, 담당자
Gui, %상태%:Add, Text, x+10 w80 h30 -VScroll, 진행률
Gui, %상태%:Font, S13 CRED W700, Malgun Gothic
Gui, %상태%:Add, Text, x+10 w80 h40 +right -VScroll vtitle, %제목%
Gui, %상태%:Font, S13 c99004C W400, Malgun Gothic
Gui, %상태%:Add, Edit, ReadOnly x10 y+5 w150 h40 -VScroll vt1,
Gui, %상태%:Add, Edit, ReadOnly x+10 w150 h40 -VScroll vt2,
Gui, %상태%:Add, Edit, ReadOnly x+10 w100 h40 -VScroll vt3,
Gui, %상태%:Add, Edit, ReadOnly x+10 w170 h40 -VScroll vt4,
Gui, %상태%:Add, Edit, ReadOnly x+10 w140 h40 -VScroll vt5,
Gui, %상태%:Add, Edit, ReadOnly x+10 w200 h40 -VScroll vt6,

Gui, %상태%:Add, Edit, ReadOnly x+10 w60 h40 -VScroll vt7,
Gui, %상태%:Add, Edit, ReadOnly x+10 w80 h40 -VScroll vt8,

Gui, %상태%:Font, S13 CDefault W400, Malgun Gothic
Gui, %상태%:Add, Edit, x10 y+5 w150 h40 -VScroll ve1,
Gui, %상태%:Add, Edit, x+10 w150 h40 -VScroll ve2,
Gui, %상태%:Add, Edit, x+10 w100 h40 -VScroll ve3,
Gui, %상태%:Add, Edit, x+10 w170 h40 -VScroll ve4,
Gui, %상태%:Add, Edit, x+10 w140 h40 -VScroll ve5,
Gui, %상태%:Add, Edit, x+10 w200 h40 -VScroll ve6,

Gui, %상태%:Add, combobox, x+10 w60 h50 -VScroll ve7 r5 , |여|채|김
Gui, %상태%:Add, combobox, x+10 w80 h50 -VScroll ve8 r5 , 주문|진행|완료|보류|취소

Gui, %상태%:Font, S19 CDefault W400 c0xFF2211, Malgun Gothic
Gui, %상태%:Add, button, x1140 y45 w90 h40 c0xFF2211 v상태close g상태close11, 닫기
...
GuiControl, , t5, %ed5%
GuiControl, , t6, %ed6%
GuiControl, text, t7, %ed7%
GuiControl, text, t8, %ed8%
GuiControl, , t0, %상태%

if( ed1 = "")
{
GuiControl, , e1, %addtime1%
GuiControl, , e2, %addtime1%
;~ GuiControl, text, e8, 기안
}
else
{
GuiControl, , e1, %ed1%
GuiControl, , e2, %ed2%
;~ GuiControl, text, e8, %ed8%
}
GuiControl, , e3, %ed3%
GuiControl, , e4, %ed4%
GuiControl, , e5, %ed5%
...
recentfile := "A" ed1 "_A" ed2 "_B" ed3 "_C" ed4 "_D" ed5 "_E" ed6 "_V" ed7 "_G" ed8 "_" 상태 ".CSV"
...
Sleep, 200
ControlSend, Edit23, {CtrlDown}a{CtrlUp}, %상태%
Sleep, 200
ControlSend, Edit23, {CtrlDown}x{CtrlUp}, %상태%
Sleep, 200
ClipWait
		GuiControl,, myprogress, +10
ControlFocus, RICHEDIT50W1, %받는분%
...
Sleep, 200
		GuiControl,, myprogress, +10
새로운포멧 = % "A" t1 "_A" t2 "_B" t3 "_C" t4 "_D" t5 "_E" t6 "_V" t7 "_G" t8 "_" t0 ".CSV"
새로운포멧1 = % "A" e1 "_A" e2 "_B" e3 "_C" e4 "_D" e5 "_E" e6 "_V" e7 "_G" e8 "_" e0 ".CSV"
		...
		9edit_1:
{
	...
	RegExMatch(OutputVar, "A(.*)_A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V(.*)_G(.*)_C", ed)
...
Sleep, 200
		;~ GuiControl,, myprogress, +10
새로운포멧 := % OutputVar
새로운포멧1 := % "A" ed1 "_A" ed2 "_B" ed3 "_C" ed4 "_D" ed5 "_E" ed6 "_V" ed7 "_G" ed8 "_B.CSV"
...
RegExMatch(OutputVar, "A(.*)_A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V(.*)_G(.*)_B", ed)
		...
		9edit_3:
{
	...
	RegExMatch(OutputVar, "A(.*)_A(.*)_B(.*)_C(.*)_D(.*)_E(.*)_V(.*)_G(.*)_A", ed)
...
Gui, %상태%:Add, ListView, x10 y+4 w1120 h463 grid vLV47 gLV47 hwndHLV47 -ReadOnly AltSubmit WantF2 -Multi NoSortHdr, 진행률|내용|비고 및 주의사항
...
;~ LV_ModifyCol(5, 80)
;~ LV_ModifyCol(6, 190)
Gui, %상태%:Add, combobox, x10 y+3 w200 h40 v4tt1 r3, |진행중|완료
Gui, %상태%:Add, Edit, x+0 w500 h40 v4tt2,
Gui, %상태%:Add, Edit, x+0 w380 h40 v4tt3,
;~ Gui, %상태%:Add, Edit, x+0 w60 h40 v4tt4,
;~ Gui, %상태%:Add, Edit, x+0 w80 h40 v4tt5,
;~ Gui, %상태%:Add, Edit, x+0 w190 h40 v4tt6,
Gui, %상태%:Font, S13 CDefault W400, Malgun Gothic
...
Gui, %상태%:Font, S19 c99004C W400, Malgun Gothic
Gui, %상태%:Add, Edit, ReadOnly x10 y+5 w170 h40 -VScroll v4t1,
Gui, %상태%:Add, Edit, ReadOnly x+10 w170 h40 -VScroll v4t2,
Gui, %상태%:Add, Edit, ReadOnly x+10 w60 h40 -VScroll v4t3,
Gui, %상태%:Add, Edit, ReadOnly x+10 w310 h40 -VScroll v4t4,
Gui, %상태%:Add, Edit, ReadOnly x+10 w230 h40 -VScroll v4t5,

Gui, %상태%:Add, Edit, ReadOnly x+10 w60 h40 -VScroll v4t6,
Gui, %상태%:Add, Edit, ReadOnly x+10 w60 h40 -VScroll v4t7,
...
Gui, %상태%:Add, Edit, ReadOnly x+5 w15 h30 v4t0 -VScroll,
...
{
	;~ if(4t1 = ""){
		;~ GuiControl, , 4t1, %addtimetoday%
		;~ GuiControl, , 4t2, %addtimetoday%
	...
	IfMsgBox Yes
	{
		...
		MsgBox, 262196, 일정 삭제, 정말 입니까?
		{
			...
			IfMsgBox Yes
			{
				...
				Sleep, 100
				;~ GuiControl,, myprogress, 10
				TempFile := 상태 "_P" 4t1 "_Q" 4t2 "_R" 4t3 "_S" 4t4 "_T" 4t5 "_U" 4t6 ".CSV" ;  기존
...
;~ GuiControl, choosestring, 4tt1 , %Col1%
;~ ControlGet, Col2, List , selected Col2, SysListView321, %상태% ;2 모델
;~ GuiControl, , 4tt2 , %Col2%
;~ ControlGet, Col3, List , selected Col3, SysListView321, %상태% ;2 모델
;~ GuiControl, , 4tt3 , %Col3%
...
Gui, Submit, NoHide
    ...
    Loop
    {
		...
		GuiControl, choosestring, 4tt1 , %OutputVar2%
		LV_GetText(OutputVar2, selectRowNum , 2)
		GuiControl, , 4tt2 , %OutputVar2%
		LV_GetText(OutputVar2, selectRowNum , 3)
		GuiControl, , 4tt3 , %OutputVar2%
	}
...
Gui, Submit, NoHide
    ...
    LV_Insert(selectRowNum , ,4tt1,4tt2,4tt3)
	gosub, 리프레쉬4
return
...
Gui, Submit, NoHide
	...
	LV_Modify(selectRowNum , ,4tt1,4tt2,4tt3)
	gosub, 리프레쉬4
return
...
GuiControl, , 4t4, %4e4%
GuiControl, , 4t5, %4e5%
GuiControl, ChooseString, 4t6, %4e6%
GuiControl, ChooseString, 4t7, %4e7%
GuiControl, , 4t0, %4e0%
...
저장4:
		SoundPlay, %A_WorkingDir%\sound\저장중.mp3
gui, submit, nohide
A = 0
Loop, 7
{
...
;~ 상태 "_P" 4t1 "_Q" 4t2 "_R" 4t3 "_S" 4t4 "_T" 4t5 "_U" 4t6 저장포멧
...
loop, % LV_GetCount() {
	...
	loop, 3
		LV_GetText(col%A_Index% , RowNum, a_index)
			GuiControl,, myprogress, +1
	FileAppend, % col1 "," col2 "," col3 ", `n", % A_Desktop "\" TempFile1
	Sleep, 5
    }
	if erorrlevel = 0
	{
...
FileMove, % A_Desktop "\" TempFile1, % A_WorkingDir "\사무루틴\" TempFile1, 1
		GuiControl,, myprogress, 70
;~ Sleep, 2000
...
WinWaitActive, 신흥목재 전산프로그램,
Sleep, 100
ControlClick, Button30, 신흥목재 전산프로그램
if ErrorLevel = 1
{
...
Gui, %상태%:Add, combobox, x10 y+3 w60 h40 vtt1 r3,△|◎|★
Gui, %상태%:Add, Edit, x+0 w150 h40 vtt2,
Gui, %상태%:Add, Edit, x+0 w550 h40 vtt3,
Gui, %상태%:Add, Edit, x+0 w60 h40 vtt4,
Gui, %상태%:Add, Edit, x+0 w80 h40 vtt5,
Gui, %상태%:Add, Edit, x+0 w190 h40 vtt6,
Gui, %상태%:Font, S13 CDefault W400, Malgun Gothic
Gui, %상태%:Add, button, x10 y+0 w160 h32 g라인추출5,라인 추출
Gui, %상태%:Add, button, x+10 w160 h32 g라인수정5,라인 수정
Gui, %상태%:Add, button, x+50 w160 h32 g라인추가5,라인 추가
Gui, %상태%:Add, button, x+10 w160 h32 g라인삽입5,라인 삽입
Gui, %상태%:Add, button, x+50 w160 h32 g라인삭제5,라인 삭제
Gui, %상태%:Add, button, x+10 w160 h32 g지우기5,텍스트 지우기
Gui, %상태%:Add, button, x+40 w90 h32 g삭제5,일정 삭제
...
Gui, %상태%:Font, S13 CDefault W400 c0xFF2211, Malgun Gothic
Gui, %상태%:Add, button, y+40 w90 h106 cRED  v리스트로저장 g리스트로저장, Ⅰ`n출고`n리스트업
Gui, %상태%:Add, button, y+10 w90 h108 c0xFF2211  v준비중으로저장 g준비중으로저장, Ⅱ`n준비중
Gui, %상태%:Add, button, y+10 w90 h108 c0xFF2211  v준비완료로저장 g준비완료로저장, Ⅲ`n준비완료
Gui, %상태%:Add, button, y+10 w90 h108 c0xFF2211  v완료출하로저장 g완료출하로저장, Ⅳ`n출하
Gui, %상태%:Font, S1 CDefault W400, Malgun Gothic
...
PERCENT(FILENAME)
{
	...
	Loop, % Rows
	{
	 found:=CSV_Search("DATA", "완료", A_Index)
	 if found=0
		break
	 COUNT ++
	}
...
READedsm:
{
	...
	;~ OutputVar := A_WorkingDir "\" OutputVar
		...
		Clipboard = %A_WorkingDir%\일일재고관리\%OutputVar%

contain := % Clipboard



FileRead, dataedsm, %Clipboard%
	if not ErrorLevel  ; 성공적으로 적재됨.
	{
		SoundPlay, %A_WorkingDir%\sound\soundopen.mp3
	}
...
Gui, %상태%:Font, S19 CDefault W400, Malgun Gothic
gui, %상태%:Add, progress, smooth x10 y135 w1120 h35 cCCCCFF vmyprogress, 0
Gui, %상태%:Add, ListView, x10 y+4 w1120 h463 grid vLVedsm1 gLVedsm1 hwndHLVedsm1 -ReadOnly AltSubmit WantF2 -Multi NoSortHdr, 태|로케이션|품명|규격|단위|현재재고
