...
;~ CSV_Load(FileName, CSV_Identifier, Š¦… ‹¡Ñ¡); CSV Ìa·©·i ¡A¡¡Ÿ¡µA ¡—aÐaa¡e  å¸á µÅžaÐ´¡ Ðe”a.
;~ CSV_TotalRows(CSV_Identifier), Á· Ð— ® ¤eÑÅ
;~ CSV_TotalCols(CSV_Identifier); Á· µi ® ¤eÑÅ
;~ CSV_Delimiter(CSV_Identifier), ¬a¶w–E Š¦… ‹¡Ñ¡ ¤eÑÅ
;~ CSV_FileName(CSV_Identifier), Ìa·© ·¡Ÿq ¤eÑÅ
;~ CSV_Path(CSV_Identifier), ‰w¡ ¤eÑÅ
;~ CSV_FileNamePath(CSV_Identifier); ¸åÁA ‰w¡¡ Ìa·© ·¡Ÿq ¤eÑÅ
;~ CSV_Save(Ìa·© ·¡Ÿq, CSV_Identifier, OverWrite?); CSV Ìa·© ¸á¸w
;~ CSV_DeleteRow(CSV_Identifier, RowNumber); Ð— ¬b¹A
;~ CSV_AddRow(CSV_Identifier, "Cell1,Cell2..); Ð—·i ÂˆaÐe”a.
;~ CSV_DeleteColumn(CSV_Identifier, ColNumber), µi ¬b¹A
;~ CSV_AddColumn(CSV_Identifier, "Cell1,Cell2.."); µi Âˆa
;~ CSV_ModifyCell(CSV_Identifier, NewValue, Row, Coll); ‹¡¹¥ ­I ®¸÷
;~ CSV_ModifyRow(CSV_Identifier, "NewValue1, NewValue2, RowNumber)"; ‹¡¹¥ Ð— ®¸÷
;~ CSV_ModifyColumn(CSV_Identifier, "NewValue1, NewValue2...", ColNumber); ‹¡¹¥ µi ®¸÷
;~ CSV_Search(CSV_Identifier, SearchText, Instance); µA¬á ÉB¯aËa ˆñ¬‚
;~ CSV_SearchRow(CSV_Identifier, SearchText, RowNumber, Instance); Ëb¸÷ Ð— · ­I µA¬á ÉB¯aËa ˆñ¬‚
;~ CSV_SearchColumn(CSV_Identifier, SearchText, ColNumber, Instance); Ëb¸÷ µi · ­I µA¬á ÉB¯aËa ˆñ¬‚
;~ CSV_MatchCell(CSV_Identifier, SearchText, Instance); »¡¸÷–E •A·¡Èáˆa ¸÷ÑÂÓ¡ —i´á ·¶“e ­I ˆñ¬‚
;~ CSV_MatchCellColumn(CSV_Identifier, SearchText, ColNumber, Instance=1); Ëb¸÷ µiµA »¡¸÷–E •A·¡ÈáŸi ¸÷ÑÂÓ¡ Í¡ÐqÐa“e ­I ˆñ¬‚
;~ CSV_MatchCellRow(CSV_Identifier, SearchText, RowNumber, Instance=1); Ëb¸÷ Ð—µA »¡¸÷–E •A·¡ÈáŸi ¸÷ÑÂÓ¡ Í¡ÐqÐa“e ­I ˆñ¬‚
;~ CSV_MatchRow(CSV_Identifier, "SearchText1,SearchText2, Instance)"; »¡¸÷–E •A·¡Èáˆa ¸÷ÑÂÓ¡ Í¡Ðq–E Ð— ˆñ¬‚
;~ CSV_MatchCol(CSV_Identifier, "SearchText1, SearchText2, ·¥¯aÈå¯a)"; »¡¸÷–E •A·¡Èáˆa ¸÷ÑÂÓ¡ —i´á ·¶“e µi ˆñ¬‚
;~ CSV_ReadCell(CSV_Identifier, Ð—, µi); »¡¸÷–E ­IµA¬á •A·¡Èá ·ª‹¡
;~ CSV_ReadRow(CSV_Identifier, RowNumber); »¡¸÷–E Ð—µA¬á •A·¡Èá ·ª‹¡
;~ CSV_ReadCol(CSV_Identifier, ColNumber); »¡¸÷–E µiµA¬á •A·¡Èá ·ª‹¡
;~ CSV_LVLoad(CSV_Identifier, Gui, x, y, w, h, ÑA”á, Sort?, RowIdentification?,AutoAdjustCol?); »¡¸÷–E gui Àw· ¡¢¢ ¥¡‹¡¡ •A·¡Èá ¡—a, listviewname ¥e®ˆa "CSV_Identifier"µÁ ˆ{·q
;~ CSV_LVSAve(Ìa·© ·¡Ÿq, CSV_Identifier, Š¦… ‹¡Ñ¡, OverWrite?, Gui); »¡¸÷–E ¡¢¢ ¥¡‹¡Ÿi CSV Ìa·©¡ ¸á¸w, CSV_Identifier“e ListView· ‰Åe ¥e® ·¡Ÿq·¡”a.
;~ ;####################################################################################################################
;CSV Functions
;####################################################################################################################
