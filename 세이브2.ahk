...
Gui, Add, DropDownList, x+5 vfrmSAVEDPRESET gPresetChange
...
Gui, Add, Button, x+5 h21 w60 greload , Delete 
...
start:
{
    ...
    A++   
 	 ...
 	 ; 합판1-1
    CONTROL, CHOOSE, %A%, ComboBox1, 세이브 1.0
    Sleep, 500
    ...
    Sleep, 200
    ControlClick, TDBGridEh2, ahk_exe JedaeroM.exe, , , , x53 y%03%
    Sleep, 200
	ControlClick, TRzGroupButton2, ahk_exe JedaeroM.exe
    Sleep, 200
	Control, Choose, %11%,   TRzComboBox2, ahk_exe JedaeroM.exe
	ControlSetText, TRzEdit1, %12%, ahk_exe JedaeroM.exe
	Control, Choose, %13%,   TRzComboBox7, ahk_exe JedaeroM.exe
	Control, Choose, %14%,   TRzComboBox6, ahk_exe JedaeroM.exe
	Control, Choose, %15%,   TRzComboBox3, ahk_exe JedaeroM.exe
	ControlClick, TRzBitBtn3, ahk_exe JedaeroM.exe
	Sleep, 100
    	Control, Choose, %21%,   TRzComboBox2, ahk_exe JedaeroM.exe
	ControlSetText, TRzEdit1, %22%, ahk_exe JedaeroM.exe
	Control, Choose, %23%,   TRzComboBox7, ahk_exe JedaeroM.exe
	Control, Choose, %24%,   TRzComboBox6, ahk_exe JedaeroM.exe
	Control, Choose, %25%,   TRzComboBox3, ahk_exe JedaeroM.exe
	ControlClick, TRzBitBtn3, ahk_exe JedaeroM.exe
	Sleep, 100
    	Control, Choose, %31%,   TRzComboBox2, ahk_exe JedaeroM.exe
	ControlSetText, TRzEdit1, %32%, ahk_exe JedaeroM.exe
	Control, Choose, %33%,   TRzComboBox7, ahk_exe JedaeroM.exe
	Control, Choose, %34%,   TRzComboBox6, ahk_exe JedaeroM.exe
	Control, Choose, %35%,   TRzComboBox3, ahk_exe JedaeroM.exe
	ControlClick, TRzBitBtn3, ahk_exe JedaeroM.exe
	Sleep, 100
    	Control, Choose, %41%,   TRzComboBox2, ahk_exe JedaeroM.exe
	ControlSetText, TRzEdit1, %42%, ahk_exe JedaeroM.exe
	Control, Choose, %43%,   TRzComboBox7, ahk_exe JedaeroM.exe
	Control, Choose, %44%,   TRzComboBox6, ahk_exe JedaeroM.exe
	Control, Choose, %45%,   TRzComboBox3, ahk_exe JedaeroM.exe
	ControlClick, TRzBitBtn3, ahk_exe JedaeroM.exe
	Sleep, 100
    	Control, Choose, %51%,   TRzComboBox2, ahk_exe JedaeroM.exe
	ControlSetText, TRzEdit1, %52%, ahk_exe JedaeroM.exe
	Control, Choose, %53%,   TRzComboBox7, ahk_exe JedaeroM.exe
	Control, Choose, %54%,   TRzComboBox6, ahk_exe JedaeroM.exe
	Control, Choose, %55%,   TRzComboBox3, ahk_exe JedaeroM.exe
	ControlClick, TRzBitBtn3, ahk_exe JedaeroM.exe
	Sleep, 500
