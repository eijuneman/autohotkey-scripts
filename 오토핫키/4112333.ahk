...
ControlGetText, var4 , 	TRzDBEdit12, 매출전표
...
ControlSetText,TRzEdit8, %var1%, ahk_exe JedaeroM.exe 

Sleep,1000
ControlClick,TRzDBDateTimeEdit1, ahk_exe JedaeroM.exe
ControlSetText,TRzDBDateTimeEdit1,%var2%, ahk_exe JedaeroM.exe

Sleep,1000

ControlClick,TRzDBEdit13, ahk_exe JedaeroM.exe

ControlSetText,TRzDBDateTimeEdit1,%var3%, ahk_exe JedaeroM.exe

Sleep,1000

ControlClick,TDBGridInplaceEdit1, ahk_exe JedaeroM.exe
ControlSetText,TRzDBEdit12 ,%var4%, ahk_exe JedaeroM.exe

Sleep,1000

ControlClick,TRzDBEdit11, ahk_exe JedaeroM.exe
ControlSetText,TRzDBEdit11,%var5%, ahk_exe JedaeroM.exe
