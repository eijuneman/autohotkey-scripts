...
run, mother_sheets.xlsm, %A_Desktop%\cost\0_22년단가변환
Sleep, 1000
...
Send, {Ctrl Down}{Alt Down}{f5}{Ctrl Up}{Alt Up}
Sleep, 10000
...
;~ send, {enter}
	...
	Sleep, 1000
		Loop, 100
		{
			ImageSearch, x0, y0, 0, 0, 1920, 1080, *50 %A_MyDocuments%\IMAGESEARCH\01.png
...
VAR ++
		Loop
		{
			ImageSearch, x1, y1, 0, 0, 1920, 1080, *50 %A_MyDocuments%\IMAGESEARCH\1.png
	...
	WinWaitActive, 열기,
	Sleep, 1000
	Send, %A_Desktop%\cost\0_22년단가변환\%VAR%.xlsx{enter}
	...
	Sleep, 1000
		Loop
		{
			ImageSearch, x2, y2, 0, 0, 1920, 1080, *50 %A_MyDocuments%\IMAGESEARCH\2.png
	...
	Sleep, 5000
		...
		Loop
		{
			ImageSearch, x3, y3, 0, 0, 1920, 1080, *50 %A_MyDocuments%\IMAGESEARCH\3.png
