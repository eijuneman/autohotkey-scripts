...
, LVMenu.SetItem("Edit Item", (txt == "" || txt == "" || txt == "" ? "Disable" : "Enable"))
, LVMenu.SetItem("Remove Item", (txt == "" || txt == "" ? "Disable" : "Enable"))
...
else if (b["ItemName"] == "") ; Separator
PMenu.AddSeparator()
else if (b["ItemName"] == "") ; Standard items
PMenu.Standard()
if !In(b["State"], ",,Normal") { ; Item states
states := b["State"]
Loop, Parse, states, `,
...
std := IsChecked("Button7") ? (LV_Get(1, 2) == "" ? 2 : 1) : 0
...
lines .= (b["ItemName"] <> "" && b["ItemName"] <> "") ? (mLine (sLine ? (iLine ? "`r`n" sLine "`r`n" iLine "`r`n" : "`r`n" sLine "`r`n") : (iLine ? "`r`n" iLine "`r`n" : "`r`n"))) : (mLine ? mLine "`r`n" : mline)
}
if lLine {
Sort, lLine, U D
...
AddSep() {
Gui, Main:Default
LV_Add("Icon", LV_GetCount()+1, "", "","", "","", "")
, this.Items[LV_GetCount()] := {ItemName: "", UnderChar: "None", Hotkey: "", LabelorSubmenu: "", Label: 1, Disabled: 0, Checked: 0, Default: 0, IconFile: "", IconNumber: "", IconWidth: "", ExcFilePath: 0}
...
LV_Add("Icon" i, LV_GetCount()+1, "", "","", "","", "")
, this.Items[LV_GetCount()] := {ItemName: "", UnderChar: "None", Hotkey: "", LabelorSubmenu: "", Label: 1, Disabled: 0, Checked: 0, Default: 0, IconFile: A_AhkPath, IconNumber: 1, IconWidth: "", ExcFilePath: 0}
...
, LV_Modify(pos, "Col" A_Index " Icon" this.RecentIcon[pos], Posted Image
