...
Gui, Add, text, x+50 w800 H130 vr111,

Gui, Add, Edit, x100 y+10 w800 H130 va112,
Gui, Add, text, x+50 w800 H130 vr112,

Gui, Add, Edit, x100 y+10 w800 H130 va113,
Gui, Add, text, x+50 w800 H130 vr113,
...
Gui, Add, Picture, x100 y+100 va15, %A_ScriptDir%\사진\1.png
;~ Gui, Add, BUTTON, x930 y600 W240 H130 grst,정답
Gui, Add, BUTTON, x+30 W240 H130 gbefore,<이전
...
Loop, 16
{
	if(tabname=A_Index)
	{
		...
		{
			;~ MsgBox, % "틀림 `n" 작성 "`n" 정답
		Gui, Font, S40 CFF0000 w400, Malgun Gothic
		GuiControl, Font, %정답표기%
		GuiControl, , %정답표기%, % "정답:" %작성1%
		GuiControl, show, %다음표기%
		}
...
else
{
	...
	else
	{
		...
		Gui, Font, S60 CRED w400, Malgun Gothic
		GuiControl, Font, show10
		GuiControl, , show10, %q1% - %q2% = %q3% 입니다 `n 기록한은 %a10%은 오답 입니다
	}
...
{
	Gui, Font, S60 CFF0000 w400, Malgun Gothic
	GuiControl, Font, r111
	GuiControl, , r111, % "틀림:" a91
}
...
{
	Gui, Font, S60 CFF0000 w400, Malgun Gothic
	GuiControl, Font, r112
	GuiControl, , r112, % "틀림:" a92
}
...
{
	Gui, Font, S60 CFF0000 w400, Malgun Gothic
	GuiControl, Font, r113
	GuiControl, , r113, % "틀림:" a93
}
