...
SetWorkingDir, Z:\HDD1\일정표 최근\일정표220730
...
;~ Run explore Z:\HDD1\일정표 최근\일정표220730, , hide, PID
Sleep, 100
...
if (contain = "Z:\HDD1\일정표 최근\일정표220730\")
{
...
변환결과 := "[Ⅰ. 출고 리스트 업]"
GuiControl, , e0, Y
;~ SoundPlay, Z:\HDD1\일정표 최근\일정표220730\sound\골리앗1.mp3
gosub, 변환
return
...
if ((contain = "Z:\HDD1\일정표 최근\일정표220730\매입\") or (contain = "\\192.168.0.1\일정표 최근\일정표220730\매입\") )
{
