...
Gui, Add, ListView, x42 y89 w540 h200 vlv1 glv1, 안보임|날짜|업체|출고시간|장소|배송지
Gui, Add, ListView, x42 y+20 w540 h200 vlv2 glv2, 안보임|날짜|업체|출고시간|장소|배송지
Gui, Add, ListView, x42 y+20 w540 h200 vlv3 glv3, 안보임|날짜|업체|출고시간|장소|배송지
...
Gui, Add, ListView, x+10 y89 w610 h640 vlv4 glv4 -ReadOnly WantF2, 번호|내용|단위|수량|재고위치 
...
loop, % LV_GetCount() {		
	...
	FileAppend, % col1 "," col2 "," col3 "," col4 "," col5 ", `n", % TempFileZZ
    }
