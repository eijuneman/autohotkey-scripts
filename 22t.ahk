...
UserPW := "tlsgmdahrwo12#"           ; User''s password
Server := "127.0.0.1"      ; Server''s host name or IP address
Database := "mydatabase"



; note host can be hostname or ip address
db := mysql.connect(Server,UserID,UserPW,Database)     ; host,user,password,database
